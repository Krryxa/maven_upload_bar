...
function progressFunction(event) {
    ...
    if (prograssbarDom && event.lengthComputable) {
      	var percent = event.loaded / event.total; //文件上传进度百分比
